...
import { toLandProductionRecords, toLandWell } from "../src/domains/wv-land/projections";
...
test("WV facts project into minimal shared land concepts without losing publisher extensions", () => {
  const well = toLandWell({ apiNumber: "4700701733", wellNumber: "3-S-245", county: "Braxton", evidenceIds: ["e-1"], productionEvidenceIds: [], farmOrLeaseName: "Lease", operatorAtCompletion: "Historical", measuredDepth: 10 });
